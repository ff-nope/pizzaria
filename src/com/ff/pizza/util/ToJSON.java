...
public class ToJSON {
	...
	public JSONArray toJSONArray(ResultSet rs) throws Exception {
        ...
        try {
             ...
             //System.out.println("antes de entrar no loop de registros");
             while( rs.next() ) {
            	 //System.out.println("entrei no loop de registros");
                 ...
                 for (int i=1; i<numColumns+1; i++) {
                     ...
                     //System.out.println("looping coluna " + column_name );
